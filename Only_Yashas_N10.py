...
class EdgeNode():
    ...
    def transfer_learning_phase_1b(self):
        self.local_adversarial_training_MN()
...
def main():
    ...
    directory = "Date9_" + current_day + "_Time_" + current_time
    parent_dir = "/storage/home/hcoda1/1/asaz3/"
    ...
    np.savez('Only_Yashas_MNIST_10', tr_x=all_compressed_reps_tr, tr_priv=all_priv_tr, tr_tgt=all_tgt_tr,\
    ...
    client_dict[str(0)].post_hoc_adversary(all_compressed_reps_tr, all_priv_tr, all_compressed_reps_va, all_priv_va,
                                           all_compressed_reps_te, all_priv_te)
