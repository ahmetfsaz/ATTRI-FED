...
def main():
    ...
    np.('compressed_reps_Pub_MN_6', tr_x=all_compressed_reps_tr, tr_priv=all_priv_tr, tr_tgt=all_tgt_tr,\
    ...
    np.savez('Pub_EMN_4_v2', etr_x=all_compressed_reps_etr, etr_priv=all_priv_etr, etr_tgt=all_tgt_etr,\
    ...
    cr_emn = np.load('Pub_EMN_4_v2.npz')
    cr_mn = np.load('Just_Us_and_MNIST_4.npz')
                                
   
    
    client_dict[str(0)].post_hoc_adversary(cr_mn['tr_x'], cr_mn['tr_priv'], cr_mn['val_x'], cr_mn['val_priv'],
                                           cr_mn['te_x'], cr_mn['te_priv'], cr_emn['etr_x'], cr_emn['etr_priv'], cr_emn['eval_x'], cr_emn['eval_priv'],
                                           cr_emn['ete_x'], cr_emn['ete_priv'])
