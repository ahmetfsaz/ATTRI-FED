...
class EdgeNode():
    ...
    def transfer_learning_phase_1a(self):
        ...
        # YOU MADE BETA 1.5 !!!!!!!!!!!!!!!!!
        self.transfer_learning_init_EMNIST_MNIST()
        self.transfer_learning_init_EMNIST_MNIST()
        self.transfer_learning_init_EMNIST_MNIST_ADV2()
        self.transfer_learning_init_ADV_EMNIST_MNIST()
...
def main():
    ...
    np.savez('compressed_reps_Pub_MN_10', tr_x=all_compressed_reps_tr, tr_priv=all_priv_tr, tr_tgt=all_tgt_tr,\
    ...
    np.savez('compressed_reps_Pub_EMN_10', etr_x=all_compressed_reps_etr, etr_priv=all_priv_etr, etr_tgt=all_tgt_etr,\
