...
class EdgeNode():
    ...
    def post_hoc_adversary(self, tr_all, tr_priv, val_all, val_priv, te_all, te_priv):
        ...
        for epoch_num in range(-1, num_epochs_MI_U_and_Yhat):
            train_combined = tr_all
            val_combined = val_all
            test_combined = te_all
            tr_priv_combined = tr_priv
            vl_priv_combined = val_priv
            te_priv_combined = te_priv
...
def main():
    ...
    np.savez('compressed_reps_woPub_MN_2', tr_x=all_compressed_reps_tr, tr_priv=all_priv_tr, tr_tgt=all_tgt_tr,\
    ...
    cr_mn = np.load('compressed_reps_woPub_MN_12.npz')
                                
    client_dict[str(0)].post_hoc_adversary(cr_mn['tr_x'], cr_mn['tr_priv'], cr_mn['val_x'], cr_mn['val_priv'],
                                           cr_mn['te_x'], cr_mn['te_priv'])
